...
<html>
    ...
    <body background="../include/images/bgimage.jpg" >
        <div class="container-fluid">
            ...
            <br></br>	
            <form class="form-signin" method="post" action="changePassDB.php" id="defaultForm;">
            <center><h2 class="form-signin-heading" style="color:white;">Change Password</h2>
                
		<div style="float:center;"> 
                    <center><input type="pass" style="width:400px;" name="inputPass1" class="form-control" placeholder="Password" data-maxlength=20 required autofocus >
                </div>
                <br style="clear:both;" />
                <div style="float:center;">
                   <input type="pass" style="width:400px; postition: absolute;"name="inputPass2" class="form-control" placeholder="Retype" data-maxlength=20 required autofocus>
                </div>
