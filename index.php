    ...
    <body background="bgimage.jpg">
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <p>
                <button type="button" class="btn btn-primary btn-lg" onClick="window.open('/usermanagement/login.php')">Sign in</button>
                <button type="button" class="btn btn-default btn-lg" onClick="window.open('/usermanagement/signup.php')">Register</button>
                </p>
                </div>
            </div>
        </div>
